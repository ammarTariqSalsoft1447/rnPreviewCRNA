...
class AboutUs extends React.Component {
  ...
  render() {
    ...
    return (
      <ScrollView style={{ flex: 1, paddingHorizontal: vw * 5 }}>
        <ImageBackground
          source={{
            uri:
              this.props.Reducer.customData &&
              this.props.Reducer.customData?.aboutUs?.image,
          }}
          style={styles.banner}
        ...
        >
          {this.props.Reducer.customData &&
            this.props.Reducer.customData?.aboutUs?.title}
        </TextMedium>
        <TextRegular
          style={[
            styles.p1,
        ...
        >
          {this.props.Reducer.customData &&
            this.props.Reducer.customData?.aboutUs?.content}
        </TextRegular>
      </ScrollView>
    );
  }
